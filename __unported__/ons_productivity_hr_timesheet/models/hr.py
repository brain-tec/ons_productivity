...
#         new_id = super(hr_analytic_timesheet, self).create(cr, uid, vals, context=context)
#         if not new_id:
#             return False
#         row = self.browse(cr, uid, new_id, context=context)
#         if row and row.sheet_id and row.sheet_id.employee_id and not row.employee_id:
#             row.write({'employee_id': row.sheet_id.employee_id.id}, context=context)
#         
#         return new_id
# 
#     def write(self, cr, uid, ids, vals, context=None):
#         ret = super(hr_analytic_timesheet, self).write(cr, uid, ids, vals, context=context)
#         for row in self.browse(cr, uid, ids, context=context):
#             if row.sheet_id and row.sheet_id.employee_id and not row.employee_id:
#                 row.write({'employee_id': row.sheet_id.employee_id.id}, context=context)
#         
#         return ret
