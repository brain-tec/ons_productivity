# -*- coding: utf-8 -*-
#
#  File: wizard/account_statement_from_invoice.py
...
class account_statement_from_invoice_lines(osv.osv_memory):
    ...
    def populate_statement(self, cr, uid, ids, context=None):
        ...
        for line in line_obj.browse(cr, uid, line_ids, context=context):
            ...
            if self.pool.get('ir.values').get_default(cr, uid, 'account.bank.statement.line', 'onsp_use_bnk_stmt_date'):
                v_date = statement.date
                vl_date = statement.date
            else:
                v_date = line.date
                vl_date = time.strftime('%Y-%m-%d')
